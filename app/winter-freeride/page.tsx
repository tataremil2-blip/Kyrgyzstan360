...
export default function WinterFreeridePage() {
  return <main className="winter-tour">
    ...
    <section className="winter-booking" id="book"><div className="winter-booking-inner"><p className="winter-kicker">FIND OUT MORE</p><h2>Talk to our<br /><em>tour operator.</em></h2><p>Leave your contacts and tell us a little about your riding. We&apos;ll share the camp details and help you plan your freeride week in Jyrgalan.</p><InquiryForm /></div></section>
